...
manage_all_user_command "
TRUNCATE TABLE master_schema.give_point_table
restart identity;"

manage_all_user_command "
TRUNCATE TABLE master_schema.use_point_table
restart identity;"

manage_all_user_command "
TRUNCATE TABLE transaction_schema.give_point_record_table
restart identity;"

manage_all_user_command "
TRUNCATE TABLE transaction_schema.use_point_record_table
restart identity;"
...
(user_name, user_favorite, user_especially)
VALUES
('ライオン', '焼肉', '牛肉'),
('羊', 'ドリンク', '紅茶'),
('豚', 'ドリンク', '緑茶');"
...
manage_master_user_command "
INSERT INTO master_schema.give_point_table
(give_category, default_give_point)
VALUES
('経費処理',1),
('見積もり',1),
('清掃', 2);"
...
manage_master_user_command "
INSERT INTO master_schema.use_point_table
(use_category, default_use_point)
VALUES
('焼肉',15),
('ドリンク', 1),
('1on1時間確保', 1);"
...
INSERT INTO transaction_schema.give_point_record_table
(relationship_id, occur_date, give_point_id, give_point)
VALUES
...
manage_transaction_user_command "
INSERT INTO transaction_schema.use_point_record_table
(relationship_id, occur_date, use_point_id, use_point)
VALUES
